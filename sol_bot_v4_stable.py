...
BOT_NAME="OpenClaw SOL Bot v4.0"
MARKET_SERIES="KXSOL15M"
assert MARKET_SERIES=="KXSOL15M",f"WRONG MARKET: {MARKET_SERIES}"
STOP_FILE="/root/STOP_SOL"
LOG_CSV="/root/sol_trade_log.csv"
PERF_LOG="/root/sol_performance_log.json"
