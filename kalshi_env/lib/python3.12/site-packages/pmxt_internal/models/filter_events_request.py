...
class FilterEventsRequest(BaseModel):
    ...
    FilterEventsRequest
    """ # noqa: E501
    args: Annotated[List[FilterEventsRequestArgsInner], Field(min_length=2, max_length=2)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FilterEventsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FilterEventsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "args": [FilterEventsRequestArgsInner.from_dict(_item) for _item in obj["args"]] if obj.get("args") is not None else None,
