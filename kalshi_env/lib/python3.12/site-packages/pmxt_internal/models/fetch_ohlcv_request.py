...
class FetchOHLCVRequest(BaseModel):
    ...
    FetchOHLCVRequest
    """ # noqa: E501
    args: Annotated[List[FetchOHLCVRequestArgsInner], Field(min_length=2, max_length=2)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FetchOHLCVRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FetchOHLCVRequest from a dict"""
        if obj is None:
            return None
