...
class GetExecutionPriceDetailedRequest(BaseModel):
    """
    GetExecutionPriceDetailedRequest
    """ # noqa: E501
    args: Annotated[List[GetExecutionPriceRequestArgsInner], Field(min_length=3, max_length=3)]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetExecutionPriceDetailedRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetExecutionPriceDetailedRequest from a dict"""
        if obj is None:
            return None
