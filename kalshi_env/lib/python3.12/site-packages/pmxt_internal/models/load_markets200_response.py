...
class LoadMarkets200Response(BaseModel):
    """
    LoadMarkets200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    error: Optional[ErrorDetail] = None
    data: Optional[Dict[str, UnifiedMarket]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoadMarkets200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoadMarkets200Response from a dict"""
        if obj is None:
            return None
