...
class UnifiedMarket(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["marketId", "title", "description", "outcomes", "eventId", "resolutionDate", "volume24h", "volume", "liquidity", "openInterest", "url", "image", "category", "tags", "yes", "no", "up", "down"]
