...
class FetchBalance200Response(BaseModel):
    """
    FetchBalance200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    error: Optional[ErrorDetail] = None
    data: Optional[List[Balance]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FetchBalance200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FetchBalance200Response from a dict"""
        if obj is None:
            return None
