...
class CloseRequest(BaseModel):
    ...
    CloseRequest
    """ # noqa: E501
    args: Optional[Annotated[List[Any], Field(max_length=0)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CloseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CloseRequest from a dict"""
        if obj is None:
            return None
