...
class SubmitOrderRequest(BaseModel):
    ...
    SubmitOrderRequest
    """ # noqa: E501
    args: Annotated[List[BuiltOrder], Field(min_length=1, max_length=1)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "args": [BuiltOrder.from_dict(_item) for _item in obj["args"]] if obj.get("args") is not None else None,
