...
class FetchClosedOrdersRequest(BaseModel):
    ...
    """ # noqa: E501
    args: Optional[Annotated[List[OrderHistoryParams], Field(max_length=1)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FetchClosedOrdersRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FetchClosedOrdersRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "args": [OrderHistoryParams.from_dict(_item) for _item in obj["args"]] if obj.get("args") is not None else None,
