...
class FetchEvent200Response(BaseModel):
    """
    FetchEvent200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    error: Optional[ErrorDetail] = None
    data: Optional[UnifiedEvent] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FetchEvent200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FetchEvent200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": UnifiedEvent.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
