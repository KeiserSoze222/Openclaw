...
class LoadMarketsRequest(BaseModel):
    """
    LoadMarketsRequest
    """ # noqa: E501
    args: Optional[Annotated[List[StrictBool], Field(max_length=1)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoadMarketsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoadMarketsRequest from a dict"""
        if obj is None:
            return None
