...
class MarketOutcome(BaseModel):
    ...
    market_id: Optional[StrictStr] = Field(default=None, description="The market this outcome belongs to (set automatically)", alias="marketId")
    ...
    __properties: ClassVar[List[str]] = ["outcomeId", "marketId", "label", "price", "priceChange24h", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MarketOutcome from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MarketOutcome from a dict"""
        if obj is None:
            return None
