...
BOT_NAME="OpenClaw ETH Bot v4.0"
MARKET_SERIES="KXETH15M"
assert MARKET_SERIES=="KXETH15M",f"WRONG MARKET: {MARKET_SERIES}"
STOP_FILE="/root/STOP_ETH"
LOG_CSV="/root/eth_trade_log.csv"
PERF_LOG="/root/eth_performance_log.json"
